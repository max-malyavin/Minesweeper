...
const grabAllAdjacentCells = (
    ...
    const topRightCell =
      rowParam > 0 && colParam < 9 - 1
        ? cells[rowParam - 1][colParam + 1]
        : null;
    const leftCell = colParam > 0 ? cells[rowParam][colParam - 1] : null;
    const rightCell =
      colParam < 9 - 1 ? cells[rowParam][colParam + 1] : null;
    const bottomLeftCell =
      rowParam < 9 - 1 && colParam > 0
        ? cells[rowParam + 1][colParam - 1]
        : null;
    const bottomCell =
      rowParam < 9 - 1 ? cells[rowParam + 1][colParam] : null;
    const bottomRightCell =
      rowParam < 9 - 1 && colParam < 9 - 1
        ? cells[rowParam + 1][colParam + 1]
        : null;
